"""
Django settings for amazon_scrper project.
...
SECRET_KEY = '($rbn3c8mut*mbvqxepmx0igz%i51e$n(r-8fyti0f(@1i4*q8'
...
ROOT_URLCONF = 'amazon_scrper.urls'
...
WSGI_APPLICATION = 'amazon_scrper.wsgi.application'
